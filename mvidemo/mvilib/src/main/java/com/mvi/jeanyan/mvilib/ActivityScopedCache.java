...
class ActivityScopedCache {
    ...
    */
    ...
    /**
     * Get the Presenter for a given {@link MviView} if exists or <code>null</code>
     *
     * @param viewId The mosby internal view id
     * @param <P> The type tof the {@link MviPresenter}
    ...
    /**
     * Get the ViewState for a given {@link MviView} if exists or <code>null</code>
     *
     * @param viewId The mosby internal view id
     * @param <VS> The type tof the {@link MviPresenter}
     ...
     *
     * @param viewId The mosby internal View id of the {@link MviView} which the presenter is
     * associated to.
     * @param presenter The Presenter
     */
    public void putPresenter(@NonNull String viewId,
                             @NonNull MviPresenter<? extends MviView> presenter) {
