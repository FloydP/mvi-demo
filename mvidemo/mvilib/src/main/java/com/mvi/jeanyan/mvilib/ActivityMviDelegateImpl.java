...
public class ActivityMviDelegateImpl<V extends MviView, P extends MviPresenter<V>>
    ...
    @Override public void onCreate(@Nullable Bundle bundle) {
        ...
        if (DEBUG) {
            Log.d(DEBUG_TAG,
                    "MosbyView ID = " + mosbyViewId + " for MvpView: " + delegateCallback.getMviView());
        }
    }
    ...
    @Override public void onStart() {
        ...
        if (view == null) {
            throw new NullPointerException(
                    "MvpView returned from getMviView() is null. Returned by " + activity);
        }
