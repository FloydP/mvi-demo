...
public abstract class MviBasePresenter<V extends MviView, VS> implements MviPresenter<V> {
     ...
     */
    protected interface ViewIntentBinder<V extends MviView, I> {
        @NonNull
     ...
     */
    protected interface ViewStateConsumer<V extends MviView, VS> {
